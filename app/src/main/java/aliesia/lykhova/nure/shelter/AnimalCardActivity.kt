...
class AnimalCardActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (animal.booked == null) {
            bookedButton.visibility = View.VISIBLE
        } else {
            bookedTextView.visibility = View.VISIBLE
        }
        val bottomBookedFragment = BottomBookedFragment(animal)
        bookedButton.setOnClickListener {
            bottomBookedFragment.show(supportFragmentManager, "BottomBooked")
        }
